...
r_button=Button(st,text="Restart",font=("calibri",24,"bold"),
	relief=RAISED,cursor="plus",command=restart)
r_button.place(x=150,y=60,height=50,width=200)

rt_button=Button(st,text="Restart Time",font=("calibri",24,"bold"),
	relief=RAISED,cursor="plus",command=restart_Time)
rt_button.place(x=150,y=170,height=50,width=200)

lg_button=Button(st,text="Log-Out",font=("calibri",24,"bold"),
	relief=RAISED,cursor="plus",command=log_Out)
lg_button.place(x=150,y=270,height=50,width=200)

sd_button=Button(st,text="Shutdown",font=("calibri",24,"bold"),
